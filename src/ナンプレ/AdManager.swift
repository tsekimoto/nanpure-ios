...
// TEST IDs: Google's official sample ad unit IDs. Replace with the real
// AdMob ad unit IDs (created after registering the app in the AdMob
// console) before submitting a release build.
